...
for sample in args.samples.split(','):
    ...
    plt.xlabel("Size", **hfont)
    plt.ylabel("Count", **hfont)
    plt.title("LINE Insert Size Distribution", **hfont)
    fig = plt.gcf()
    ...
    plt.xlabel("Size", **hfont)
    plt.ylabel("Count", **hfont)
    plt.title("Alu Insert Size Distribution", **hfont)
    fig = plt.gcf()
    ...
    plt.xlabel("Size", **hfont)
    plt.ylabel("Count", **hfont)
    plt.title("SVA Insert Size Distribution", **hfont)
    fig = plt.gcf()
    ...
    plt.xlabel("Size", **hfont)
    plt.ylabel("Count", **hfont)
    plt.title("ERV Insert Size Distribution", **hfont)
    fig = plt.gcf()
    ...
    plt.xlabel("Location", **hfont)
    plt.ylabel("Coverage", **hfont)
    plt.title("LINE Element Coverage Breakdown", **hfont)
    fig = plt.gcf()
    ...
    plt.xlabel("Location", **hfont)
    plt.ylabel("Coverage", **hfont)
    plt.title("Alu Element Coverage Breakdown", **hfont)
    ...
    plt.xlabel("Location", **hfont)
    plt.ylabel("Coverage", **hfont)
    plt.title("SVA Element Coverage Breakdown", **hfont)

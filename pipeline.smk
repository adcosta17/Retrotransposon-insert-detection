...
rule filter_by_reference_sample:
    input:
        file="{sample}/read_analysis/{sample}.{test}.read_insertions.repbase_annotated.high_confidence.tsv",
        sc="{sample}/read_analysis/{sample}.{test}.read_soft_clipped.repbase_annotated.high_confidence.tsv"
    output:
        "{sample}/read_analysis/{sample}.{test}.read_insertions_and_soft_clipped.repbase_annotated.high_confidence.reference_filtered.tsv"
    threads: 1
    params:
